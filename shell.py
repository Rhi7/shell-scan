...
class ZeroScann():
    ...
    def scan(self):
        ...
        found = []
        # respon code
        resp_codes = {403 : "request forbidden", 401 : "authentication required"}
            ...
            try:
                ...
                try:
                    ...
                    if e.code == 404:
                        ...
                        print("\033[96m[\033[90m{0}\033[96m]".format(time.strftime("%H:%M:%S")),"\033[96m[?] \033[93mPotential Positive", (psx, resp_codes[e.code]))
